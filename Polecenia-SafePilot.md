Przesyłam w załączniku odpowiedź na moje stare pytanie, przeanalizuj je i na bazie tego oczekuje:

1. Wygeneruj plik README dla tego projektu repozytorium.

2. Wygeneruj plik .gitignore i SECURITY.md dla WordPress PHP.

3. Wygeneruj workflow dla tego repozytorium pod aplikacje WordPress PHP.

4. Struktura strony: [Home - index.html], [About - about.html], [Services - services.html], [Services Details - service-details.html], [Portfolio - project.html], [Portfolio Details - project-details.html], [FAQ&Pytania - faq.html], [Blog - news.html], [Blog Details - news-details.html], [Kontakt - contact.html], [404 error page - 404.html].

5. Chcę obsługę block themes (FSE).

6. Elementy strukturalne WordPress PHP Scaffold motywu WordPress: [style.css], [functions.php], 
   [header.php - template-parts/top-bar.php include w header.php.
   top.bar.php - ma zawierać z pliku static/index-3.html:
   ...
   template-parts/menu-main.php include w header.php 
   menu-main.php - ma zawierać z pliku static/index.html:
...
<footer class="footer-section pt-100 bg-theme-color2">
      <div class="container">
         <div class="contact-info-area">
            ...
            <div class="contact-info-items wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
               <div class="icon">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer-layout style1">
               <div class="row">
                  ...
                  <div class="col-xl-4 col-md-6 col-12">
                     <div class="widget footer-widget wow fadeInUp" data-wow-delay="1.3s" style="visibility: visible; animation-delay: 1.3s; animation-name: fadeInUp;">
                        <h3 class="widget_title">Recent Posts</h3>
                        <div class="recent-post-wrap">
                           <div class="recent-post">
                              <div class="media-img">
                                 <a href="news-details.html"><img src="assets/img/footer/footerThumb1_1.png" alt="thumb"></a>
                              </div>
                              <div class="media-body">
                                 <div class="recent-post-meta">
                                    <a href="news-details.html"><img src="assets/img/icon/calendarIcon.svg" alt="icon">15th April, 2024</a>
                                 </div>
                           ...
                           <div class="recent-post">
                              <div class="media-img">
                                 <a href="news-details.html"><img src="assets/img/footer/footerThumb1_2.png" alt="thumb"></a>
                              </div>
                              <div class="media-body">
                                 <div class="recent-post-meta">
                                    <a href="news-details.html"><img src="assets/img/icon/calendarIcon.svg" alt="icon">20th June, 2024</a>
                                 </div>
...
[page.php - include header.php, display the_content (Gutenberg Editor Blocks), include footer.php],

[page.php - include header.php, display the_content (Gutenberg Editor Blocks), include footer.php].

[archive.php - include header.php, display post loop structure Blog Grid (static/news.html), include footer.php],

[template-parts/footer-widget.php - w jednym row na 4 kolumny w jednej lini],

[single.php - ma mieć strukturę static/news-details.html bez sekcji sidebara tylko fullwidth content. include header.php, display the_content post type post, include footer.php],

[Register Custom Post Type - "Portfolio" - single-portfolio.php - include header.php, display the_conten post type Portfolio, include footer.php]

[Custom Post Type "Portfolio" ma ogólne Archiwa strony archive.php],

[Create Page Template - page-faq.php - include header.php, display the_conten from files static/faq.html section <section class="faq-section-2 fix section-padding">, include footer.php],

[404.php - include header.php, display the_content from files static/404.html section <section class="Error-section section-padding fix">, include footer.php].



6. Elementy edytowalne w customizerze: [Logo], [Favicon], [Main Menu (submenu) (has-dropdown [megamenu]) [Dostosuj > Menu > Pozycja > Search Menu (search-trigger search-icon)], [Dostosuj > Menu > Pozycja > Top bar right button (header-button ms-4)], [Dostosuj > Widgety > Footer 4 columns].
- /wp-admin/ - z menu w kokpicie zakładka "SafePilot - Ustawienia motywu" - 
...
Do edycji z backendu pole a href [mailto:] i [tel:]

7. Dodatkowe funkcje: [Formularze kontaktowe - integracja z pluginem Contact Form 7], [Blog], [Edytowalne Social Media Icons].

8. Język panelu: [Język polski - PL].

9. Nazewnictwo: Elementy z przedrostkie [safepilot-].

10. Minimalna zgoność PHP/WP - PHP 8.2

11. Integracja z Bootstrap (enqueue w functions.php) i konwersja HTML do części szablonu (header, footer, sidebar, template parts).

12. Dynamiczne treści: menu, logo, kontakt, hero, usługi — przez Customizer + Gutenberg (theme.json + block styles). Dla listy usług rekomenduję CPT “services” lub użycie bloków/ACF (jeśli chcesz GUI do repeaterów).

13. SEO: meta, schemat JSON-LD, kompatybilność z Yoast/Rank Math, poprawne nagłówki. Pod każdym Custom Post Type i Post Type na zapleczu w edytorze strony Gutenberg SEO Strony, do wypełnienia pola tekstowe które wypełniają meta tagi SEO dla każdej edytowanej z osobna strony. Przykład meta tagów:

<meta name="keywords" content="strony internetowe, sklepy internetowe, tworzenie stron internetowych, tworzenie sklepów internetowych" />
...
        <link rel="canonical" href="$seo_canonical_url_page">

        <!-- Meta Tagi Open Graph -->

        <meta property="og:title" content="$page_title" />

        <meta property="og:description" content="$seo_description_open_graph" />

        <meta property="og:image" content="$featured_image_page" >

        <meta property="og:locale" content="pl_PL"/>

        <meta property="fb:app_id" content="$facebook_app_id_number" />

        <meta property="og:type" content="website" />



1. Accessibility & performance: WCAG, aria, kontrasty, lazyload, preconnect/critical CSS.

2. Testy: dev → staging → prod.

3. Zawartość statycznego szablonu: wszystkie HTML, CSS, JS, obrazy, fonty - znajduje się w repozytorium w folderze static/

4. Enqueue Bootstrap, theme stylesheet, fonts oraz minimalny JS.

5. add_theme_support dla: title-tag, post-thumbnails, html5, custom-logo, editor-styles, align-wide, responsive-embeds.

6. Zarejestruj menu główne (primary) i footer menu. Dodaj obszary widgetów (footer, contact-widget).

7. Dodaj theme.json aby stylować domyślny edytor (ustaw brand colors, font sizes, layout). Dodaj block-templates i patterny (np. hero + services pattern) by klient mógł budować strony w Gutenberg.

8. Sprawdz kontrasty (kolory brandowe poniżej), aria-labels, role, klawiaturowość, skip-to-content. Testy Lighthouse i a11y.

9. Sugestie architektury dynamicznych treści. Numer telefonu, adres, hero text → Customizer (łatwe dla klienta). Sekcja „Usługi” → CPT 'service' z template archive-single — to umożliwi rozbudowę. „O nas” i „Kontakt” → strony w WP z edytorem Gutenberg (możesz dostarczyć block patterns by łatwo składać layout). Stopka/contact widget → widgety + dynamiczne pola z Customizer.

10. Kolory brandu zdefiniuj w theme.json i w CSS zmiennie (przykładowo z root vars).
...
3. Co zrobię ja (jak Copilot Space)
* Pomogę stworzyć pliki motywu (snippety i PRy po Twoim potwierdzeniu).
* Zaintegruję Bootstrap i fonty.
* Utworzę obsługę Customizer + theme.json + block styles + podstawowe patterny dla Gutenberga.
* Opcjonalnie: stworzę CPT 'services' i podstawowe ACF (jeśli dostarczysz licencję) lub pola w Customizer.

Podczas pracy nad przerabianiem szablonu, pamiętaj o Responsywności (mobile-first), Kontrastach kolorów, WCAG 2.2, nad bieżąco optymalizacja kodu, motywu JS CSS pod względem pomiaru Google Page Speed.
